...
export class Game {
  ...
  private checkCollisions() {
    ...
    // Optimization: Spatial pruning reduces collision checks from O(N) to O(log N + M)
  ...
  private draw() {
    ...
    // Draw objects: Spatial pruning + Path2D batching for high-performance rendering
