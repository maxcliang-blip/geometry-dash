...
export class Game {
  ...
  /**
   * Finds the index of the first object that could potentially be visible or collide.
   * Relies on this.level.objects being sorted by x-coordinate.
   */
  ...
  private draw() {
    ...
    // Batch objects by type using Path2D
