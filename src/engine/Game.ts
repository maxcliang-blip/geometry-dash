...
export class Game {
  ...
  /**
   * Optimization: Use binary search to find the first object that could be visible or colliding.
   * Accounts for maxObjWidth to ensure objects starting before minX but overlapping it are included.
   */
  ...
  /**
   * Optimization: Spatial pruning using the sorted objects array.
   * Only iterates over objects within the relevant X range.
   */
  ...
  private draw() {
    ...
    // Optimization: Batch drawing calls using Path2D and spatial pruning
