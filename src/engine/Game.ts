...
export class Game {
  ...
  /**
   * Performs a binary search to find the first index of an object that might be visible
   * starting from minX. We subtract maxObjWidth to include objects that start before
   * minX but extend into the visible area.
   */
